...
import { useRealTimeTasks } from './entities/task/api/useRealTimeTasks';
...
function MainAppContent() {
  // Активируем событийный реалтайм-слушатель SignalR WebSocket
  useRealTimeTasks();
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#faf6ee] dark:bg-[#15110d] text-[#2e241c] dark:text-[#ede4d8] transition-colors duration-300">
      ...
      {/* Глобальный контейнер JRPG real-time уведомлений */}
      <ToastContainer />
